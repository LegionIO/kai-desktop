...
import { useFallbackBanner, useRuntimeNotice } from '@/providers/RuntimeProvider';
...
export const FallbackBanner: FC = () => {
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl items-center gap-3 rounded-xl border border-amber-500/30 bg-amber-500/8 px-3 py-2 text-xs text-amber-200 md:px-4 md:py-2.5">
...
export const RuntimeNoticeBanner: FC = () => {
  const { message, dismiss } = useRuntimeNotice();
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl items-center gap-3 rounded-xl border border-amber-500/30 bg-amber-500/8 px-3 py-2 text-xs text-amber-200 md:px-4 md:py-2.5">
      ...
      <span className="flex-1">
        ...
        {fallbackBanner.error ? <span className="text-amber-300/70"> because of {fallbackBanner.error}</span> : null}
      </span>
      <button
        type="button"
