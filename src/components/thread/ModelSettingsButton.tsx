...
}> = ({ selectedModelKey, onSelectModel, reasoningEffort, onChangeReasoningEffort, fallbackEnabled, onToggleFallback, useAgentSdk, onToggleAgentSdk, selectedProfileKey, onSelectProfile, filter, fallbackToUnfilteredWhenEmpty, executionMode, onChangeExecutionMode }) => {
          ...
          {currentModel?.resolvedBackendLabel && (
            ...
            <div className="flex items-center justify-between px-3 py-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wide">{currentModel.resolvedBackendLabel}</span>
              </div>
              <button
                type="button"
