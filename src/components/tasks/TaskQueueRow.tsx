...
import { KAI_TASK_STATUS_LABELS, KAI_TASK_STATUS_OUTER_BORDER_COLORS } from '@/types/task';
...
export const TaskQueueRow: FC<TaskQueueRowProps> = memo(({ status, tasks, selectedTaskId, onTaskClick }) => {
  ...
  return (
    <div className="relative pt-2.5">
      ...
      <div className="absolute left-3 top-0 z-10 flex items-center gap-2 px-1.5 bg-background">
        <h3 className={cn('text-[11px] font-semibold uppercase tracking-wider', KAI_TASK_STATUS_LABEL_COLORS[status])}>
