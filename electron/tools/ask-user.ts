...
const questionSchema = z.object({
  ...
  options: z.array(questionOptionSchema).min(2).max(6).describe('Available choices (2-4 options preferred, up to 6 maximum). Each should be distinct. Do NOT include an "Other" option — one is provided automatically by the UI.'),
