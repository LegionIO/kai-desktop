...
(function() {
  ...
  window.app = {
    ...
    agent: {
      ...
      approveToolCall: function(id, conversationId, runNonce) { return invoke('agent:approve-tool', id, conversationId, runNonce); },
      rejectToolCall: function(id, conversationId, runNonce) { return invoke('agent:reject-tool', id, conversationId, runNonce); },
      dismissToolCall: function(id, conversationId, runNonce) { return invoke('agent:dismiss-tool', id, conversationId, runNonce); },
      answerToolQuestion: function(id, answers, conversationId, runNonce) { return invoke('agent:answer-tool-question', id, answers, conversationId, runNonce); },
    ...
    conversations: {
      ...
      getActiveState: function() { return invoke('conversations:get-active-state'); },
      setActiveId: function(id, expectedCurrentId, expectedCurrentRevision) { return invoke('conversations:set-active-id', id, expectedCurrentId, expectedCurrentRevision); },
    ...
    plugins: {
      ...
      pause: function(pn) { return invoke('plugin:pause', pn); },
      resume: function(pn) { return invoke('plugin:resume', pn); },
      kill: function(pn) { return invoke('plugin:kill', pn); },
      ...
      denyConsent: function(pn, expectedFileHash) { return invoke('plugin:deny-consent', pn, expectedFileHash); },
