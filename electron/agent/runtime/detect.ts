 ...
 * Required for the pi coding-agent runtime to function.
 */
...
/**
 * Returns the absolute path to the `pi` CLI binary if found on PATH, or
 * `undefined` if not found. The pi runtime spawns this path directly.
 */
